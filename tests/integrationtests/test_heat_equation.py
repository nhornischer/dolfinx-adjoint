...
def heat_equation_problem():
    ...
    problem = fem.petsc.NonlinearProblem(F, u_next, petsc_options_prefix="nls_")
    ...
    while t < T:
        ...
        problem = fem.petsc.NonlinearProblem(F, u_next, graph=graph_, petsc_options_prefix = "nls_")
